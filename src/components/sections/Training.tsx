...
export default function Training() {
  return (
    <section id="capacitacion" className="section-padding relative overflow-hidden">
      <div className="absolute top-1/2 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-greencyan/5 rounded-full blur-[100px] sm:blur-[150px]" />
